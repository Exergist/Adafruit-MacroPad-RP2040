...
/* 	32x32 PC silhouette, 1-bit, page-ordered, LSB = top pixel
	Draw using ==> oled_blit_P(pc32x32, 32, 32, 48, 16) */
...
/* 	40x40 PC silhouette, 1-bit, page-ordered, LSB = top pixel
	Draw using ==> oled_blit_P(pc40x40, 40, 40, 44, 16) */
...
/* 	48x48 PC silhouette, 1-bit, page-ordered, LSB = top pixel
	Draw using ==> oled_blit_P(pc48x48, 48, 48, 40, 16) */
...
/* 	56x56 PC silhouette, 1-bit, page-ordered, LSB = top pixel
	Draw using ==> oled_blit_P(pc56x56, 56, 56, 36, 8) */
...
/* 	64x64 PC silhouette, 1-bit, page-ordered, LSB = top pixel
	Draw using ==> oled_blit_P(pc64x64, 64, 64, 32, 0) */
